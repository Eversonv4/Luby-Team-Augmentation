...
export function ScaleTechTeamSection() {
  return (
    <Container id="scaleteam-section">
      ...
      <Description>
        Demand for IT professionals is getting higher by the day, which has made
        both salaries and time to source skyrocket. All the work to properly
        evaluate these professionals, both technically and culturally, as well
        as retaining them has become a huge toll on Tech and Talent Acquisition
        teams alike. At Luby, we have mastered this process like few others in
        this industry, as we have been helping companies with their IT projects
        and personnel for the past 20 years
      </Description>
