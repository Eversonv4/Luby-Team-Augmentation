      ...
      <ContainerLayout>
        ...
        <QuestionContainer>
          <div>
            ...
            >
              <p>
                ...
                requirements of the job description your company has created for
                that position.
              </p>

              <p>
                This practice is very common to add technical talent to your
                team on an on-demand basis so your company can scale as fast as
                your growth goals.
              </p>
              ...
              <p>
                ...
                We cover different chapters, technology stacks and mid to senior
                level professionals.
              </p>
            </Accordeon>
            ...
            >
              <p>
                On the Extended Teams offering, the squads are fully managed by
                Luby and the professionals are selected by our team without the
                client's validation. On the other hand, for the Team
                Augmentation format the allocated personnel are hired by Luby,
                but onboarded and fully managed by the client. The client still
                relies on Luby's resources to guarantee the professional
            ...
            >
              <p>
                Any company or business that needs specialized development teams
                can make use of the Team Augmentation services as long as they
                have a tech structure in place. IT Team Augmentation services
                are not offered to companies that do not have a tech
            ...
            >
              <p>
                Luby's IT Team Augmentation Process will be implemented through
                the following steps:
              </p>
              <ul>
                <li>
                ...
                <li>
                  <strong>Interview Process</strong> - Luby's TA team will then
                  source the candidate either on our immediately available bench
                  or through a custom made selective process. In both situations
                  the candidates will go through cultural assessment and
                ...
                <li>
                  <strong>Engagement Start</strong> - Once the professionals are
                  selected, we assign an official start date for the engagement;
                </li>
                <li>
                  <strong>Full Allocation Transparency</strong> - Every month
                  your company receives a timesheet report with the total number
                  of hours that were worked by the professionals during the
                  period alongside the respective invoice;
                </li>
                <li>
                  ...
                  motivated and delivering according to the expectations of the
                  position.
                </li>
                <li>
                  <strong>Continuous Follow-Ups and Feedback</strong> - Luby's
                  CS team will constantly follow up with the client to check
                  performance and make sure we can address any possible problems
                  before they happen
                </li>
              </ul>
            </Accordeon>
          ...
          <div>
            ...
            >
              <p>
                As all of Luby's professionals are working remotely from Brazil,
                we provide services to all clients in the United States and
                Canada through a nearshoring model:
              </p>
              <ul>
                <li>
                  Given Brazil's geographic location, all working professionals
                  are able to provide the services during the same business
                  hours as our client's, in all four continental time zones in
                  North America.
                </li>
                <li>
                  In case on-site collaboration is required, our team is able to
                  visit through several direct overnight flights to the biggest
                  cities of the US and Canada.
                </li>
                <li>
            ...
            >
              <p>
                ...
                Team augmentation process will reduce your recruitment time and
                tech personnel liabilities.
              </p>
            </Accordeon>
            ...
            >
              <p>
                ...
                conditions, finally providing up to 4 highly adherent candidates
                for each position. We will always work with the same level of
                commitment for every client, so all allocated personnel are
                fully dedicated to that client to avoid any quality or data
                risks.
              </p>
            </Accordeon>
          </div>
